    ...
    return Material(
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text('Publica el aviso de tu cuarto'),
            leading: IconButton(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      autofocus: true,
                      validator: (value) =>
                          value.isEmpty ? 'Avenida / Jr / Barrio es requerido' : null,
                    ),
                    TextFormField(
                      ...
                      validator: (value) =>
                          value.isEmpty ? 'Ciudad es requerida' : null,
                    ),
                    TextFormField(
                      ...
                      validator: (value) =>
                          value.isEmpty ? 'Departamento es requerido' : null,
                    ),
                    TextFormField(
                      decoration: InputDecoration(labelText: 'Numero de calle'),
                      style: new TextStyle(
                        fontFamily: "Poppins",
                        fontSize: 16.0,
                      ),
                      ...
                      validator: (value) =>
                          value.isEmpty ? 'Porfavor ingrese el numero de calle' : null,
                    ),
                    TextFormField(
                      maxLines: 2,
                      ...
                      validator: (value) =>
                          value.isEmpty ? 'Nombre de la casa es necesario' : null,
                      style: new TextStyle(
                        fontFamily: "Poppins",
                      ),
                    ),
                    TextFormField(
                      ...
                      validator: (value) =>
                          value.isEmpty ? 'Codigo postal es requerido' : null,
                    ),
                    Align(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Expanded(
                                    child: TextFormField(
                                      decoration: new InputDecoration(
                                        hintText: 'Area en metros cuadrados',
                                        contentPadding:
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Expanded(
                                    child: TextFormField(
                                      decoration: new InputDecoration(
                                        hintText: 'Deposito inicial en soles',
                                        fillColor: Colors.white,
                                        contentPadding:
                                            const EdgeInsets.all(10.0),
                                      ),
...
class FacilitiesFilterState extends State<FacilitiesFilter> {
  final List<ActorFilterEntry> _cast = <ActorFilterEntry>[
    const ActorFilterEntry('Aire Acondicionado', 'AC'),
    const ActorFilterEntry('Lavadora', 'WM'),
    const ActorFilterEntry('Estacionamiento', 'CP'),
    const ActorFilterEntry('Wi-Fi', 'WF'),
    const ActorFilterEntry('Restaurantes cerca', 'TF'),
    const ActorFilterEntry('Agua 24x7', 'WF'),
    const ActorFilterEntry('Parque cercano', 'GR'),
    const ActorFilterEntry('Piso', 'LF'),
    const ActorFilterEntry('Tv por cable', 'CC'),
    const ActorFilterEntry('Sotea', 'SP'),
    const ActorFilterEntry('Seguridad', 'SC'),
    const ActorFilterEntry('Cerca a paradero', 'CP'),
    const ActorFilterEntry('Gimnasios cerca', 'GY'),
    const ActorFilterEntry('Limpieza', 'HK'),
    const ActorFilterEntry('Seguro ante incendios', 'FS'),
  ];
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        Text('Estas buscando: ${_filters.join(', ')}'),
      ],
    );
  }
}
...
class _MyStatefulWidgetState extends State<MyStatefulWidget> {
  ...
  void something(int e) {
    setState(() {
      if (e == 1) {
        groupValue = 1;
        String apartment = 'Totalmente amoblado';
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      decoration: new InputDecoration(
                                        ...
                                        hintText: 'Ingresa el numero de baños',
                                        fillColor: Colors.white,
                                        contentPadding:
    ...
    return Center(
      child: Column(
        ...
        children: <Widget>[
          Column(
            children: <Widget>[
              checkbox("Estudiantes", stdVal),
              checkbox("Egresados", baVal),
              checkbox("Solo chicos", boyVal),
              checkbox("Solo chicas", girlVal),
              checkbox("Todos", anyVal),
            ],
          ),
        ],
      ),
      ...
      child: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(choice.title, style: TextStyle(fontWeight: FontWeight.bold)),
          ],
        ),
      ),
    );
...
class _MultiImageState extends State<MultiImage> {
  ...
  Future<Null> _addImages(var pic) async {
    ...
    Reference ref = storage.refFromURL('gs://farfromhome-2019-1f111.appspot.com').child(filePath);
