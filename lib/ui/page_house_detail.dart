...
final owdata = ownerSnapshot.data() as Map<String, dynamic>;
...
DocumentSnapshot snapshot;  
  ...
  void ownerDetail() async {
    ...
    FirebaseFirestore.instance.doc('/User/'+userReference).get().then((DocumentSnapshot ds){
      final docData = ds.data() as Map<String, dynamic>;

      print('Loged in with '+ds['firstName']);
      if(docData.containsKey('FavouriteHouse')){
            ...
            child: Row(
              children: <Widget>[
                Container(
                  width: size.hp(15),
                  color: Colors.grey,
                  child: owdata.containsKey("profileImage") ? Image.network(
